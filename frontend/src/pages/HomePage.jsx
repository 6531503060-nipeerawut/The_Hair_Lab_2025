    ...
    <div>
      <section className="text-center py-20">
        ...
        <p className="text-xl text-gray-700 mb-8">
          Transform your look with expert stylists. Book your perfect salon appointment in just a few clicks ✨
        </p>
        <Link
          to="/user/login"
      ...
      <section className="bg-white py-20 text-center">
        <h2 className="text-4xl font-bold mb-12 text-purple-600">Why Choose Us</h2>
      ...
      <section className="text-center py-20">
        <h2 className="text-4xl font-bold text-purple-600 mb-12">Get In Touch</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div>
